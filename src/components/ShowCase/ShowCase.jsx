  ...
  return (
    ...
    <div className='flex flex-col items-center gap-y-24 text-white mt-32'>
      ...
      <div className='flex lg:flex-row flex-col'>
        {/* Image 1 */}
        <span data-aos="fade-left" className='relative md:left-16 z-10 transform md:-translate-x-8 -rotate-12'>
        ...
        {/* Image 2 */}
        <span data-aos="fade-left" className='relative md:left-4 -top-16 lg:top-0 z-20 transform md:-translate-x-4 shadow-2xl'>
        ...
        {/* Image 3 */}
        <span data-aos="fade-left" className='relative md:right-4 -top-24 lg:top-0 z-30 transform md:-translate-x-2 shadow-2xl'>
        ...
        {/* Image 4 */}
        <span data-aos="fade-left" className='relative md:right-16 -top-32 lg:top-0 z-40 shadow-2xl'>
