...
const CaseStudy = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-16 lg:mx-24 mx-4 lg:my-24 my-16">
      ...
      <div data-aos="fade-in" className='w-full xl:text-6xl sm:text-3xl lg:text-5xl md:text-4xl text-3xl flex md:flex-row flex-col gap-6 items-center justify-center'>
      ...
      <div>
        {/* Description text */}
        <p data-aos="fade-in" className="xl:mx-56 my-6 text-gray-500">
        ...
        <p data-aos="fade-in" className="text-center mb-16 text-gray-500">Unleash Your Creativity Today!</p>
